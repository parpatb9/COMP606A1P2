...
<html lang="en" dir="ltr">
  ...
  <body style="margin:0;padding:0;">
    <div class="" align="center" style="background-color:#000;color:#fff;font-size:20px;height:800px;">
      <?php
      ...
      ?>
      <br><br><br><a href="index.php" style="color:#FFF;">Go to the Application</a>
    </div>
